...
_GESTURE_LIST = ['CloseTab', 'MaximizeWindow', 'NewTab', 'OpenChrome', 'OpenCNN', 'OpenGoogle', 'OpenMusic', 'OpenNetflix', 'OpenWeather', 'OpenYouTube', 'RefreshTab', 'RestoreWindow', 'ScrollDown', 'ScrollUp', 'ZoomIn', 'ZoomOut']
